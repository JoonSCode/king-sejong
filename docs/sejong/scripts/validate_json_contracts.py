...
SCHEMA_FILES = {
    ...
    "ralph_executor": SEJONG_ROOT / "ralph-executor.schema.json",
...
FORMAT_TO_SCHEMA = {
    ...
    "uigwe.ralph-executor-request/v0.3-draft": "ralph_executor",
    "uigwe.ralph-executor-result/v0.3-draft": "ralph_executor",
    "uigwe.ralph-executor-request/v0.4-draft": "ralph_executor",
    "uigwe.ralph-executor-result/v0.4-draft": "ralph_executor",
