...
SCHEMA_FILES = {
    ...
    "session_binding": SEJONG_ROOT / "session-binding.schema.json",
    "repo_index": SEJONG_ROOT / "repo-index.schema.json",
    ...
    "worker_resource_lease": SEJONG_ROOT / "worker-resource-lease.schema.json",
    "worker_cleanup_receipt": SEJONG_ROOT / "worker-cleanup-receipt.schema.json",
...
FORMAT_TO_SCHEMA = {
    ...
    "king-sejong.session-binding/v0.1": "session_binding",
    "king-sejong.repo-index/v0.1": "repo_index",
    ...
    "sejong.worker-resource-lease/v0.1-draft": "worker_resource_lease",
    "sejong.worker-cleanup-receipt/v0.1-draft": "worker_cleanup_receipt",
