...
- `$team` / `TeamExecutor` wrappers that launch separate Codex CLI or explicitly configured compatible workers in `tmux` panes and coordinate through Sejong-owned state files
